...
function PodiumCard({ user }: { user: LeaderboardEntry }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex items-center gap-1 text-[11px] font-black uppercase tracking-wide"
        style={{ color: tone }}
      >
...
function LeaderboardRow({ user }: { user: LeaderboardEntry }) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`flex h-8 w-8 items-center justify-center rounded-xl border-2 text-sm font-black ${
          isRising
