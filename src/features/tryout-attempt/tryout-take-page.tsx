...
import {
  ...
  submitAttempt,
} from "./student-attempt-functions";
import { reportAttemptQuestion } from "./student-question-report-functions";
...
export function TryoutTakePage({ tryout }: { tryout: TryoutPreparation }) {
