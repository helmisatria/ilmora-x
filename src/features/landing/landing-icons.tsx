...
function fixedSvgSize(
  width: number,
  height = width,
): { height: number; style: CSSProperties; width: number } {
  return {
    height,
    style: { display: "block", flexShrink: 0, height, width },
    width,
  };
}
...
export function SparkIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true" {...fixedSvgSize(20)}>
      <path
...
export function FlameIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" aria-hidden="true" {...fixedSvgSize(20)}>
...
export function TargetBadgeIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" aria-hidden="true" {...fixedSvgSize(24)}>
...
export function TrendingUpIcon() {
  return (
    <svg viewBox="0 0 80 40" className="h-8 w-24" fill="none" aria-hidden="true" {...fixedSvgSize(96, 32)}>
...
export function ShieldCheckIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-9 w-9" fill="none" aria-hidden="true" {...fixedSvgSize(36)}>
...
export function InfoIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4 text-stone-300" fill="none" aria-hidden="true" {...fixedSvgSize(16)}>
