...
import { getLevelForXp, getXpProgress } from "../engagement-surface/level-catalog";
import { restoreReturnScroll, saveReturnScroll } from "../../lib/return-scroll";
import type { listProgressSummary } from "./student-progress-functions";

type ProgressSummary = Awaited<ReturnType<typeof listProgressSummary>>;

export function ProgressPage({ summary }: { summary: ProgressSummary }) {
