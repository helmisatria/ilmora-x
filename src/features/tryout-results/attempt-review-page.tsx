...
export type AttemptReviewPageData = {
  attemptId: string;
  result: Awaited<ReturnType<typeof getAttemptResult>>;
  search: z.infer<typeof attemptReviewSearchSchema>;
};

export function AttemptReviewPage({ attemptId, result, search }: AttemptReviewPageData) {
