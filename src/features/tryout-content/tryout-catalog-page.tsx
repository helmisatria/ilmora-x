...
import { productAnalyticsEvents, type AcquisitionIntent } from "../../lib/product-analytics";
...
import type { listPublishedTryouts } from "./student-tryout-catalog-functions";
...
export function TryoutCatalogPage({
  intent,
  summary,
  tryouts,
}: {
