...
export const seedMateri: Materi[] = [
  {
    ...
    topicId: "farmakologi-antibiotik-antibiotik",
    accessLevel: "free",
  ...
  },
  {
    ...
    categoryId: "klinis",
    subCategoryId: "klinis-kardiovaskular",
    topicId: "klinis-kardiovaskular-hipertensi",
    accessLevel: "premium",
  ...
  },
  {
    ...
    topicId: "farmasi-klinik-perhitungan-dosis-perhitungan-dosis",
    accessLevel: "premium",
